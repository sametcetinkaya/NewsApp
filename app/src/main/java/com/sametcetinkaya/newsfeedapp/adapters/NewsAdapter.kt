package com.sametcetinkaya.newsfeedapp.adapters
...
import com.sametcetinkaya.newsfeedapp.databinding.NewsItemBinding
import com.sametcetinkaya.newsfeedapp.utils.dateFormat
...
class NewsAdapter : ListAdapter<Article, NewsAdapter.ArticleViewHolder>(diffCallBack) {
    ...
    class ArticleViewHolder(val binding: NewsItemBinding) :
        ...
        fun bind(article: Article) {
            ...
            binding.date.text = article.publishedAt.dateFormat()
